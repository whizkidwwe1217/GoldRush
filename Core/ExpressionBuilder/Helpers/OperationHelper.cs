...
using GoldRush.Core.ExpressionBuilder.Exceptions;
using GoldRush.Core.ExpressionBuilder.Interfaces;
using System;
using System.Collections.Generic;
using System.Linq;

namespace GoldRush.Core.ExpressionBuilder.Helpers
{
    /// <summary>
    ...
    public class OperationHelper : IOperationHelper
    {
        ...
        public static void LoadDefaultOperations()
        {
            ...
            var operationsFound = AppDomain.CurrentDomain.GetAssemblies()
                .Where(a => a.DefinedTypes.Any(t => t.Namespace == "GoldRush.Core.ExpressionBuilder.Operations"))
